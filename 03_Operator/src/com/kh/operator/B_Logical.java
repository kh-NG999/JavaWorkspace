...
public class B_Logical {
	 ...
	 *                    둘중 하나라도 false 값이 들어간 경우 false 반환
	 * OR  || : a || b -> a와 b 모두 거짓인 경우에만 false 반환
	 *                    둘중 하나라도 true 값이 들어간 경우 true 반환
	 * */
	...
	public void method1() {
     ...
     public void method3() {
    	 // 사용자가 입력한 값이 'y' 혹은 'Y'인 경우 TURE, 아니면 FALSE
    	 Scanner sc = new Scanner(System.in);
     ...
     public void method4() {
    	 ...
    	 // 뒤쪽 조건들은 "무조건" false이기 떄문에 뒤쪽 조건식은 실행되지도 않는다.
    	 ...
    	 int num2 = 10;
    	 // or연산자는 A || B 중 A가 참일경우 뒤 쪽 조건식은 검사하지 않고 참을 반환
