...
public class B_ArrayCopy {
	...
	public void method3() {
		...
		//System.arraycopy(origin, 0, copy, 0, 5); // copy에 [1 2 3 4 5 0 0 0 0 0] 저장 
		
		// 0 3 4 5 0 0 0 0 0 0
		//System.arraycopy(origin, 2, copy, 1, 3);
		
		int[] origin = {1,2,3,4,5,0,0,0,0,0};
		System.arraycopy(origin, 0, origin, 1, 5); // [0,1,2,3,4,5,0,0,0,0]
		origin[0] = 0;
	...
	public void method5() {
		...
		System.out.println(origin == copy); // false 깊은 복사임
		System.out.println(Arrays.toString(copy));
	}
