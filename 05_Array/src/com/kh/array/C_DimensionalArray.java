...
public class C_DimensionalArray {
	...
	public void method1() {
		...
		// 이차원 배열 할당
		// 배열 = new 자료형 [행크기(2차원배열크기)][열크기(1차원배열크기)]
		arr3 = new int[2][3];
		...
		System.out.println(arr); //2차원배열주소
		System.out.println(arr[0]); //1차원배열
		System.out.println(arr[0][0]); //1차원배열이 관리하는 0번째 값
	...
	public void method3() {
		...
		System.out.println(arr2[0]); //null값으로 초기화된 상태
		...
		int value = 1;
		for(int i=0; i<arr2.length; i++)//i는2차원{
