...
public class A_Array {
	...
	public void method1() {
		...
		System.out.println(arr3[3]); // 0 -> 초기화 시키지 않았음에도 0이 출력 -> 자료형의 기본값으로 입력이 되어있음
		//System.out.println(a); = 오류남
		System.out.println(arr3); // [I@626b2d4a (자료형@16진수로 표현된 주소값)
	}
	...
	public void method2() {
		...
		System.out.println("iArr : "+iArr); // 주소값 출력됨
		...
		int [] iArr3 = iArr2;
		System.out.println(iArr3 == iArr2); // true (주소값 복사)
	}
	...
	public void method4() {
		...
		int result = 0;
		String str = null; // "";
		int [] arr = null; // 참조자료형의 기본값이 대입됨
		
		System.out.println(arr[0]); // 에러, 적절한 주소값이 있어야 실행되는데 기본값들은 주소값이 없기 때문
		System.out.println(str.equals("")); // 에러, 적절한 주소값이 있어야 실행되는데 기본값들은 주소값이 없기 때문
		System.out.println(arr.length); // 에러, 적절한 주소값이 있어야 실행되는데 기본값들은 주소값이 없기 때문
	}
	...
	public void method5() {
		...
		arr = null; // 참조형 변수에 null값을 대입하면, 가비지컬렉터가 해당 메모리를 즉시 삭제시켜준다
	...
	public void method6() {
		...
		// arr1 != arr2 (주소값이 달라서 데이터는 같은데 같지는 않음)
	}
